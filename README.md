...
Construyo sistemas donde la **seguridad no es un agregado, sino parte del diseño**.
...
Plataforma orientada a empresas para simular ataques de phishing y analizar el comportamiento de usuarios frente a amenazas.
...
Desarrollar sistemas donde la **seguridad, la arquitectura y la experiencia del usuario trabajen juntos**.
