...
> Base para aprender backend, seguridad y diseño de sistemas.
...
Gestor y generador de credenciales con enfoque en seguridad local-first.  
Diseñado para minimizar la exposición de secretos y evitar dependencias externas.

**Incluye:**
- Generación de contraseñas seguras
- Evaluación de fortaleza
- Manejo de credenciales en entorno local (browser)
- Base para futuras funcionalidades de cifrado y vault

🔗 Demo: https://neymors.github.io/Thalamos/  
🔗 Repo: https://github.com/Neymors/Thalamos
...
Desarrollar sistemas donde la seguridad sea parte del diseño desde el inicio (security by design).
